...
# If you get "running scripts is disabled" error, run ONE of these commands:
#
# Option 1 (Recommended): Run this script with bypass
#   powershell -ExecutionPolicy Bypass -File .\run-idms.ps1
#
# Option 2: Set policy for current user (one-time setup)
#   Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser
#   Then run: .\run-idms.ps1
#
...
# Handle execution policy setup if requested
if ($SetExecutionPolicy) {
    ...
    try {
        ...
        Write-Host "You can now run PowerShell scripts without the bypass command." -ForegroundColor Green
        Write-Host ""
        Write-Host "Run this script again without the -SetExecutionPolicy flag:" -ForegroundColor Cyan
        ...
        Write-Host ""
        Write-Host "Alternative: Run with bypass each time:" -ForegroundColor Cyan
        Write-Host "   powershell -ExecutionPolicy Bypass -File .\run-idms.ps1" -ForegroundColor White
        Write-Host ""
        exit 1
    }
}
